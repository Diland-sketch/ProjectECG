...
namespace Entidades
{
    public class SesionECG
    {
        ...
        public SesionECG(int idSesion, DateTime inicioSesionECG, DateTime finSesionECG, string descripcion, string idPaciente, string idMedico, string estado, Incidentes incidentes)
        {
            IdSesion = idSesion;
